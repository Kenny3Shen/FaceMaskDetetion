...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/icon/doctor.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-radius:0px;}")
        ...
        self.label_7.setStyleSheet("image: url(:/img/icon/doctor.png)")
...
"")
        ...
        self.thinSpinBox = QtWidgets.QSpinBox(self.groupBox_8)
        self.thinSpinBox.setMinimumSize(QtCore.QSize(50, 0))
        self.thinSpinBox.setStyleSheet("QSpinBox{\n"
"background:rgba(200, 200, 200,50);\n"
"color:white;\n"
"font-size: 14px;\n"
"font-family: \"Microsoft YaHei UI\";\n"
...
"border-image: url(:/img/icon/箭头_列表收起.png);}\n"
"")
        self.thinSpinBox.setMinimum(1)
        self.thinSpinBox.setMaximum(5)
        self.thinSpinBox.setObjectName("thinSpinBox")
        self.horizontalLayout_16.addWidget(self.thinSpinBox)
        self.thinSlider = QtWidgets.QSlider(self.groupBox_8)
        self.thinSlider.setStyleSheet("QSlider{\n"
"border-color: #bcbcbc;\n"
"color:#d9d9d9;\n"
"}\n"
"QSlider::groove:horizontal {                                \n"
...
" background: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 #373737, stop:0.25 #373737, stop:0.5 #373737, stop:1 #373737);                     \n"
"}")
        self.thinSlider.setMinimum(1)
        self.thinSlider.setMaximum(5)
        self.thinSlider.setOrientation(QtCore.Qt.Horizontal)
        self.thinSlider.setObjectName("thinSlider")
        self.horizontalLayout_16.addWidget(self.thinSlider)
...
"")
        ...
        self.raw_video.setStyleSheet("color: rgb(255, 255, 255);\n"
"")
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "Face Mask Detetion System"))
        self.label_4.setText(_translate("mainWindow", "人脸口罩实时检测系统"))
        self.label_5.setText(_translate("mainWindow", "设置 Setting"))
        ...
        self.label_10.setText(_translate("mainWindow", "选择输入"))
        self.fileButton.setToolTip(_translate("mainWindow", "选择文件"))
        self.cameraButton.setToolTip(_translate("mainWindow", "选择摄像头"))
        self.rtspButton.setToolTip(_translate("mainWindow", "网络流媒体"))
        self.label_2.setText(_translate("mainWindow", "IoU"))
        self.label.setText(_translate("mainWindow", "置信度"))
        self.label_8.setText(_translate("mainWindow", "帧间延迟"))
        self.checkBox.setToolTip(_translate("mainWindow", "开启可减少资源消耗"))
        self.checkBox.setText(_translate("mainWindow", "启用"))
        self.label_9.setText(_translate("mainWindow", "边框大小"))
        self.label_11.setText(_translate("mainWindow", "检测统计 Statistics"))
        self.label_6.setText(_translate("mainWindow", "检测 Detetion"))
        self.runButton.setToolTip(_translate("mainWindow", "开始检测"))
        self.stopButton.setToolTip(_translate("mainWindow", "停止检测"))
